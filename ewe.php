...
if ($check2 == 0) {die('O nome de usuário ou aldeia está errado. <a href=dorf1.php>Clique aqui para voltar à sua aldeia</a>');}
//Gives error if user dosen't exist
$check2 = mysql_num_rows($check);
if ($check2 == 0) {die('O nome de usuário ou aldeia está errado. <a href=dorf1.php>Clique aqui para voltar à sua aldeia</a>');}                    
...
while($row = mysql_fetch_array($sql)){
$gold = $row["gold"];};
if ($gold < 50 ) {die('Desculpe, você não tem ouro o bastante');}
else {
