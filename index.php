...
<head>
	...
	<script src="new3.js" type="text/javascript"></script>
...
<body class="presto indexPage">
	<div class="wrapper">
		...
		<?php $q = mysql_query("SELECT vref FROM ".TB_PREFIX."fdata WHERE f99 = '100' and f99t = '40'");
		$isThere = mysql_num_rows($q);?>
		
		
		<tr><td><span><?php echo PLAY_NOW; ?></td><td></td><td>&nbsp;&nbsp;&nbsp;<?php echo STARTED;?></td><td><?php echo START_DAT; ?></td></tr>
		<tr>
		<?php
		if($isThere > 0)
		{
		?>
		<?php $sql = mysql_query("SELECT endtime FROM ".TB_PREFIX."movement order by moveid desc limit 1")or die(mysql_error());
		$wingsrtime = mysql_result($sql, 0);?>
		</tr>
		<tr><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;Servidor terminado em: </td>
		<td><?PhP echo date('d/m/Y', $wingsrtime);?> às <?PhP echo date('H:i:s', $wingsrtime);?>	<?php
	...
	<div id="signup_list" class="overlay_content">
		...
		<?php if($isThere == 0){ ?>
						...
						<div id="texto3" class="label_players c0"><?php echo PLAYERS; ?>: <?php echo $users; ?></div>
						<div id="texto2" class="label_online c0"><?php echo ONLINE; ?>: <?php echo $online; ?></div>
		<?php }else{  ?>
