...
<h1><?php echo $village->vname; if($village->loyalty!='100'){ if($village->loyalty>'33'){ $color="green"; }else{ $color="red"; } ?><div id="loyality"><span style="color:<?php echo $color; ?>;font-size:xx-small;" size><?php echo Lealdade; ?> <?php echo floor($village->loyalty); ?>%</span></div><?php } ?></h1>
