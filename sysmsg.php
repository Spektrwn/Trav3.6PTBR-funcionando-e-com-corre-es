...
{
	if ($_POST['confirm'] == 'Não' ) $Interupt = true;
...
<form method="POST" action="sysmsg.php" name="myform" id="myform">
			<table cellspacing="1" cellpadding="1" class="tbg" style="background-color:#C0C0C0; border: 0px solid #C0C0C0; font-size: 10pt;">
			  <tbody>
				<tr>
				  <td class="rbg" style="font-size: 10pt; text-align:center;">Mensagem do Sistema</td>
				</tr>
				<tr>
			...
			<textarea class="fm" name="message" cols="60" rows="23"></textarea></td>
				...
				<tr>
				  <td style="text-align:center;">Todos os campos são obrigatórios</td>
				</tr>
				<tr>
...
<a href="sysmsg.php?del">Excluir a antiga mensagem do sistema</a>
<?php }elseif (@$NextStep){?>
<form method="POST" action="sysmsg.php">
			<table cellspacing="1" cellpadding="2" class="tbg">
			  <tbody>
				<tr>
				  <td class="rbg" colspan="2">Confirmação</td>
				</tr>
				<tr>
				  <td style="text-align: left; width: 200px;">Você realmente deseja enviar mensagem de sistema?</td>
				  <td style="text-align: left;">
					<input type="submit" style="width: 240px;" class="fm" name="confirm" value="Sim">
					<input type="submit" style="width: 240px;" class="fm" name="confirm" value="Não"></td>
				</tr>
			  </tbody>
			</table>
</form>
Exemplo: (BBCode ou aspas ("") não funcionam aqui!)
<?php
...
<?php }elseif (@$done){?>
Mensagem do sistema foi enviada
<?php }else{die("Algo está errado");}?>
</div>
