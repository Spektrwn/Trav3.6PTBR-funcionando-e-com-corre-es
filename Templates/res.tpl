...
<div id="resWrap">
	...
	<table cellpadding="1" cellspacing="1">
        ...
        <td></td>
			<td><?php 
			if($session->gold <= 1){
            echo '<font color="#B3B3B3"><img src="'.GP_LOCATE.'img/a/gold_g.gif" alt="Remaining gold" title="Você está atualmente com: '.$session->gold.' gold"/> '.$session->gold.' <span><span>G</span><span>o</span><span>l</span><span>d</span></span></font>';
			}
			else if($session->gold >=2){
			echo '<img src="'.GP_LOCATE.'img/a/gold.gif" alt="Remaining gold" title="Você está atualmente com: '.$session->gold.' gold"/> '.$session->gold.' <span><span>G</span><span>o</span><span>l</span><span>d</span></span>';
			}
			?>
			</td>
