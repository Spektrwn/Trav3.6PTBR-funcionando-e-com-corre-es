...
<table class="troop_details" cellpadding="1" cellspacing="1">
	...
	<tbody><tr>
		<td class="line-first column-first large"><img class="unit u1" src="img/x.gif" title="Legionário" alt="Legionário"> <input class="text" <?php if ($enforce['u1']<=0) {echo ' disabled="disabled"';}?> name="t1" value="<?php echo $enforce['u1']; ?>" maxlength="6" type="text">
		<?php 
        ...
        ?>
        <td class="line-first regular"><img class="unit u7" src="img/x.gif" title="Aríete" alt="Aríete"> <input class="text" <?php if ($enforce['u7']<=0) {echo ' disabled="disabled"';}?> name="t7" value="<?php echo $enforce['u7']; ?>" maxlength="6" type="text">
		<?php 
        ...
        <td class="line-first column-last small"><img class="unit u9" src="img/x.gif" title="Senador" alt="Senador"> <input class="text" <?php if ($enforce['u9']<=0) {echo ' disabled="disabled"';}?> name="t9" value="<?php echo $enforce['u9']; ?>" maxlength="6" type="text">
		<?php 
	...
	<tr>
		<td class="column-first large"><img class="unit u2" src="img/x.gif" title="Pretoriano" alt="Pretoriano"> <input class="text" <?php if ($enforce['u2']<=0) {echo ' disabled="disabled"';}?> name="t2" value="<?php echo $enforce['u2']; ?>" maxlength="6" type="text">
		<?php 
        ...
        ?>
		<td class="regular"><img class="unit u8" src="img/x.gif" title="Catapulta de Fogo" alt="Catapulta de Fogo"> <input class="text" <?php if ($enforce['u8']<=0) {echo ' disabled="disabled"';}?> name="t8" value="<?php echo $enforce['u8']; ?>" maxlength="6" type="text">
		<?php 
       	echo"<span class=\"none\">(".$enforce['u8'].")</span></td>";

        ?>
		<td class="column-last small"><img class="unit u10" src="img/x.gif" title="Colonizador" alt="Colonizador"> <input class="text" <?php if ($enforce['u10']<=0) {echo ' disabled="disabled"';}?> name="t10" value="<?php echo $enforce['u10']; ?>" maxlength="6" type="text">
		<?php 
	...
	<tr>
		<td class="line-last column-first large"><img class="unit u3" src="img/x.gif" title="Imperiano" alt="Imperiano"> <input class="text" <?php if ($enforce['u3']<=0) {echo ' disabled="disabled"';}?> name="t3" value="<?php echo $enforce['u3']; ?>" maxlength="6" type="text">
		<?php 
