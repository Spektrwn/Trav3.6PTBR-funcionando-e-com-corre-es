			...
			<table class="troop_details" cellpadding="1" cellspacing="1">
				...
				<tbody class="units">
					...
					<tr>
                        ...
                        <td><img src="img/x.gif" class="unit u43" title="Guardião" alt="Guardião"></td>
...
?>
    ...
    <?php } ?>
        ...
        <?php if(isset($kata) AND $process['c']!='2'){?><tr>
            ...
            <?php if($process['c']=='3'){ ?><tbody class="cata">
                <tr>
                    ...
                    <?php if($building->getTypeLevel(16) == 20) { ?>
                     <select name="ctar2" class="dropdown">
                            ...
                            <optgroup label="Recursos">
                                ...
                                <option value="0">Poço de Barro</option>
                            ...
                            <optgroup label="Militar">
                                ...
                                <option value="14">Praça de Torneio</option>
                    ...
                    <span class="info">(Será atacado por catapultas))</span>
                     </td>
                </tr>
            </tbody><?PHP  
            }
            ...
            <td colspan="<?php if($process['t11'] != ''){ echo"11"; }else{ echo"10"; } ?>">
                ...
                echo"Atenção: A catapulta <b>SOMENTE</b> atira com um ataque normal (elas não atiram com assalto!)";
                ?>
                </td>
        ...
        <?php } ?>
            ...
            <div class="at">às <span id="tp2"> <?php echo $generator->procMtime(date('U')+$time,9)?></span><span> horas</span></div>
