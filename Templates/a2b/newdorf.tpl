...
<h1>Fundar nova aldeia</h1>
	...
	<thead>
		<tr>
			<td class="role"><a href="karte.php?d=<?php echo $founder['0']; ?>&c=<?php echo $generator->getMapCheck($founder['0']); ?>"><?php echo $session->username; ?></a></td><td colspan="10"><a href="karte.php?d=<?php echo $newvillage['id']; ?>&c=<?php echo $generator->getMapCheck($newvillage['0']) ?>">Fundar nova aldeia (<?php echo $newvillage['x']; ?>|<?php echo $newvillage['y']; ?>)</a></td>
		</tr>
	</thead>
	<tbody class="units">
		<tr>
	...
	<tbody class="infos">
		<tr>
			<th>Duração</th>
				<td colspan="10"><img class="clock" src="img/x.gif" alt="Duração" title="Duração" /> <?php echo $generator->getTimeFormat($time); ?></td>
		</tr>
	</tbody>
	<tbody class="infos">
		<tr>
			<th>Recursos</th>
				<td colspan="10">
				<img class="r1" src="img/x.gif" alt="Madeira" title="Madeira" />750 | 
				<img class="r2" src="img/x.gif" alt="Barro" title="Barro" />750 | 
				<img class="r3" src="img/x.gif" alt="Ferro" title="Ferro" />750 | 
...
<?php
  ...
  print "$cps/$need_cps pontos de cultura";
}
?>
</form>
</p>
