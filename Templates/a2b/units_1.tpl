...
<form method="POST" name="snd" action="a2b.php"><input name="timestamp" value="1278280730" type="hidden"> <input name="timestamp_checksum" value="597fa8" type="hidden"> <input name="b" value="1" type="hidden">
	...
	<tbody><tr>
		<td class="line-first column-first large"><img class="unit u1" src="img/x.gif" title="Legionário" onclick="document.snd.t1.value=''; return false;" alt="Legionário"> <input class="text" <?php if ($village->unitarray['u1']<=0) {echo ' disabled="disabled"';}?> name="t1" value="" maxlength="6" type="text">
		<?php 
        ...
        ?>
        <td class="line-first regular"><img class="unit u7" src="img/x.gif" title="Aríete" alt="Aríete"> <input class="text" <?php if ($village->unitarray['u7']<=0) {echo ' disabled="disabled"';}?> name="t7" value="" maxlength="6" type="text">
		<?php 
        ...
        <td class="line-first column-last small"><img class="unit u9" src="img/x.gif" title="Senador" alt="Senador"> <input class="text" <?php if ($village->unitarray['u9']<=0) {echo ' disabled="disabled"';}?> name="t9" value="" maxlength="6" type="text">
		<?php 
	...
	<tr>
		<td class="column-first large"><img class="unit u2" src="img/x.gif" title="Pretoriano" alt="Pretoriano"> <input class="text" <?php if ($village->unitarray['u2']<=0) {echo ' disabled="disabled"';}?> name="t2" value="" maxlength="6" type="text">
		<?php 
        ...
        ?>
		<td class="regular"><img class="unit u8" src="img/x.gif" title="Catapulta de Fogo" alt="Catapulta de Fogo"> <input class="text" <?php if ($village->unitarray['u8']<=0) {echo ' disabled="disabled"';}?> name="t8" value="" maxlength="6" type="text">
		<?php 
        ...
        ?>
		<td class="column-last small"><img class="unit u10" src="img/x.gif" title="Colonizador" alt="Colonizador"> <input class="text" <?php if ($village->unitarray['u10']<=0) {echo ' disabled="disabled"';}?> name="t10" value="" maxlength="6" type="text">
		<?php 
	...
	<tr>
		<td class="line-last column-first large"><img class="unit u3" src="img/x.gif" title="Imperiano" alt="Imperiano"> <input class="text" <?php if ($village->unitarray['u3']<=0) {echo ' disabled="disabled"';}?> name="t3" value="" maxlength="6" type="text">
		<?php 
