...
<thead><tr><th colspan="7">Armazém</th></tr>
<tr><td>Aldeia</td>
<td><img class="r1" src="img/x.gif" title="Madeira" alt="Madeira"></td>
<td><img class="r2" src="img/x.gif" title="Barro" alt="Barro"></td>
<td><img class="r3" src="img/x.gif" title="Ferro" alt="Ferro"></td>
<td><img class="clock" src="img/x.gif" title="Tempo para encher o armazém" alt="Tempo"></td>
<td><img class="r4" src="img/x.gif" title="Cereal" alt="Cereal"></td>
<td><img class="clock" src="img/x.gif" title="Tempo para encher o celeiro" alt="Tempo"></td>
</tr></thead><tbody>
<?php
