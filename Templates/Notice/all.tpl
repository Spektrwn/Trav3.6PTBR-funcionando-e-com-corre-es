...
/*$noticeClass = array("Scout Report","Won as attacker without losses","Won as attacker with losses","Lost as attacker with losses","Won as defender without losses","Won as defender with losses","Lost as defender with losses","Lost as defender without losses","Reinforcement arrived","","Wood Delivered","Clay Delivered","Iron Delivered","Crop Delivered","","Won as defender without losses","Won as defender with losses","Lost as defender with losses","Won scouting as attacker","Lost scouting as attacker","Won scouting as defender","Lost scouting as defender","Scout Report");*/
$noticeClass = array("Relatório do Espião","Ganhou como atacante sem perdas","Ganhou como atacante com perdas","Perdeu como um atacante com perdas","Ganhou como defensor sem perdas","Ganhou como defensor com perdas","Perdeu como defensor com perdas","Perdeu como devensor sem perdas","Reforço chegou","","Entregua de Madeira","Entrega de Barro","Entrega de Ferro","Entrega de Cereal","","Ganhou como defensor sem perdas","Ganhou como defensor com perdas","Perdeu como defensor com perdas","Espião ganhou como atacante","Espião perdeu como atacante ","Espião ganhou como defensor","Espião perdeu como defensor","Relatório de Espião");
?>
...
<table cellpadding="1" cellspacing="1" id="overview"
	...
	<thead>
		<tr>
			...
			<th class="sent">
<a href="berichte.php?s=0&amp;o=1">Enviado</a></th>
		</tr>
	</thead><tfoot>
		<tr><th><?php
    ...
    echo "&laquo;<a href=\"?s=10&t=1\">&raquo;</a>";
    }
    else if(isset($_GET['s']) && count($message->noticearray) > $_GET['s']) {
    	if(count($message->noticearray) > ($_GET['s']+10) && $_GET['s']-10 < count($message->noticearray) && $_GET['s'] != 0) {
         echo "<a href=\"?s=".($_GET['s']-10)."&t=1\">&laquo;</a><a href=\"?s=".($_GET['s']+10)."&t=1\">&raquo;</a>";
         }
         else if(count($message->noticearray) > $_GET['s']+10) {
         	echo "&laquo;<a href=\"?s=".($_GET['s']+10)."&t=1\">&raquo;</a>";
         }
        else {
        echo "<a href=\"?s=".($_GET['s']-10)."&t=1\">&laquo;</a>&raquo;";
        }
    }
	}
	if ($_GET['t'] == 2){
    ...
    echo "&laquo;<a href=\"?s=10&t=2\">&raquo;</a>";
    }
    else if(isset($_GET['s']) && count($message->noticearray) > $_GET['s']) {
    	if(count($message->noticearray) > ($_GET['s']+10) && $_GET['s']-10 < count($message->noticearray) && $_GET['s'] != 0) {
         echo "<a href=\"?s=".($_GET['s']-10)."&t=2\">&laquo;</a><a href=\"?s=".($_GET['s']+10)."&t=2\">&raquo;</a>";
         }
         else if(count($message->noticearray) > $_GET['s']+10) {
         	echo "&laquo;<a href=\"?s=".($_GET['s']+10)."&t=2\">&raquo;</a>";
         }
        else {
        echo "<a href=\"?s=".($_GET['s']-10)."&t=2\">&laquo;</a>&raquo;";
        }
    }
	}
	if ($_GET['t'] == 3){
    ...
    echo "&laquo;<a href=\"?s=10&t=3\">&raquo;</a>";
    }
    else if(isset($_GET['s']) && count($message->noticearray) > $_GET['s']) {
    	if(count($message->noticearray) > ($_GET['s']+10) && $_GET['s']-10 < count($message->noticearray) && $_GET['s'] != 0) {
         echo "<a href=\"?s=".($_GET['s']-10)."&t=3\">&laquo;</a><a href=\"?s=".($_GET['s']+10)."&t=3\">&raquo;</a>";
         }
         else if(count($message->noticearray) > $_GET['s']+10) {
         	echo "&laquo;<a href=\"?s=".($_GET['s']+10)."&t=3\">&raquo;</a>";
         }
        else {
        echo "<a href=\"?s=".($_GET['s']-10)."&t=3\">&laquo;</a>&raquo;";
        }
    }
	}
	if ($_GET['t'] == 4){
    ...
    echo "&laquo;<a href=\"?s=10&t=4\">&raquo;</a>";
    }
    else if(isset($_GET['s']) && count($message->noticearray) > $_GET['s']) {
    	if(count($message->noticearray) > ($_GET['s']+10) && $_GET['s']-10 < count($message->noticearray) && $_GET['s'] != 0) {
         echo "<a href=\"?s=".($_GET['s']-10)."&t=4\">&laquo;</a><a href=\"?s=".($_GET['s']+10)."&t=4\">&raquo;</a>";
         }
         else if(count($message->noticearray) > $_GET['s']+10) {
         	echo "&laquo;<a href=\"?s=".($_GET['s']+10)."&t=4\">&raquo;</a>";
         }
        else {
        echo "<a href=\"?s=".($_GET['s']-10)."&t=4\">&laquo;</a>&raquo;";
        }
    }
	}
	if ($_GET['t'] == 5){
    ...
    echo "&laquo;<a href=\"?s=10&t=5\">&raquo;</a>";
    }
    else if(isset($_GET['s']) && count($message->noticearray) > $_GET['s']) {
    	if(count($message->noticearray) > ($_GET['s']+10) && $_GET['s']-10 < count($message->noticearray) && $_GET['s'] != 0) {
         echo "<a href=\"?s=".($_GET['s']-10)."&t=5\">&laquo;</a><a href=\"?s=".($_GET['s']+10)."&t=5\">&raquo;</a>";
         }
         else if(count($message->noticearray) > $_GET['s']+10) {
         	echo "&laquo;<a href=\"?s=".($_GET['s']+10)."&t=5\">&raquo;</a>";
         }
        else {
        echo "<a href=\"?s=".($_GET['s']-10)."&t=5\">&laquo;</a>&raquo;";
        }
    }
	}
    ?>
...
<?php 
    ...
    if(count($message->noticearray) == 0) {
     echo "<td colspan=\"3\" class=\"none\">Não existem relatórios disponíveis.</td></tr>";
    } 
    ?>
</tbody>
