...
<?php
		...
		echo '<div class="c">Para fundar uma nova aldeia você precisa de um nível 10 ou 20 residência e 3 colonos. A fim de conquistar uma nova aldeia você precisa de um nível 10 ou 20 residência e um senador, chefe ou chefe.</div>';
	}
