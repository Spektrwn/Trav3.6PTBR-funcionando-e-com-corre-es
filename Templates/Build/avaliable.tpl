...
?>
<div id="build" class="gid0"><h1>Construir novo edifício</h1>
<?php
...
if($session->tribe == 2 && $brewery == 0 && $brewery1 == 0 && $rallypoint >= 10 && $granary == 20  && $village->capital == 1 && $id != 39 && $id != 40) {
...
if($id != 39 && $id != 40) {
?>
<p class="switch"><a id="soon_link" href="javascript:show_build_list('soon');">Mostrar edifícios disponível em breve</a></p>
...
if($greatworkshop == 0 && $workshop >= 18 && $village->capital == 0 && GREAT_WKS) {
   ...
   ?>
    ...
    href="javascript:show_build_list('all');">mostrar mais</a></p>
...
function show_build_list(list) {
    ...
    if (build_list.className == 'hide') {
        ...
        if (link == soon_link) {
            link.innerHTML = 'esconder edifícios disponíveis em breve';
            if (all_link !== null) {
                all_link.className = '';
            }
        } else {
        ...
        if (link == soon_link) {
            link.innerHTML = 'mostrar mais edifícios disponíveis em breve';
            if (all_link !== null) {
                all_link.innerHTML = 'mostrar mais';
                all_link.className = 'hide';
                build_list_all.className = 'hide';
            }
        } else {
            link.innerHTML = 'mostrar mais';
        }
    }
}
</script>
