<div id="build" class="gid30"><a href="#" onClick="return Popup(30,4);" class="build_logo">
    <img class="building g30" src="img/x.gif" alt="Grande Cavalariça" title="Grande Cavalariça" />
</a>
<h1>Grande Cavalariça <span class="level">Nível <?php echo $village->resarray['f'.$id]; ?></span></h1>
<p class="build_desc">Sua cavalaria pode ser treinado na grande Cavalariça. Quanto maior o seu nível, mais rapidamente as tropas são treinadas.<br /></p>
<br></br>
...
<form method="POST" name="snd" action="build.php">
    ...
    <?php
        ...
        echo "<b>O treinamento pode começar quando os grandes estábulos forem terminados.</b><br>\n";
    }
