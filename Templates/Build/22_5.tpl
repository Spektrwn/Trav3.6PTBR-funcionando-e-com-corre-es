...
<?php if($fail > 0) { 
	echo "<p class=\"switch\"><a id=\"researchFutureLink\" href=\"#\" onclick=\"return $('researchFuture').toggle();\">Mostrar mais</a></p>
     ...
     echo "<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u44\" title=\"".U44."\" alt=\"".U44."\" src=\"img/x.gif\"/>
            ...
            <a href=\"#\" onclick=\"return Popup(44, 5);\">Academia </a><span title=\"+2\">Nível 1</span><br /><a href=\"#\" onclick=\"return Popup(15, 4);\">Edifício principal</a>
     ...
     echo "<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u45\" title=\"".U45."\" alt=\"".U45."\" src=\"img/x.gif\"/>
			...
			<a href=\"#\" onclick=\"return Popup(45, 4);\">Academia </a><span title=\"+2\">Nível 5</span><br /><a href=\"#\" onclick=\"return Popup(20, 4);\">Cavalaria </a>
     ...
     echo "<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u48\" title=\"".U48."\" alt=\"".U48."\" src=\"img/x.gif\"/>
            <a onclick=\"return Popup(48, 1);\" href=\"#\">".U48."</a></div></td><td class=\"cond\"><a href=\"#\" onclick=\"return Popup(21, 4);\">Oficina</a>
