...
<p><b>NPC completo.</b> Custou 3<img src="img/x.gif" class="gold" alt="Ouro" title="Ouro" /></p> 
<a href="javascript: history.go(-2)">Voltar para o edifício</a> 
<?php } else { ?>

<p>Com o comerciante NPC você pode distribuir os recursos em seu armazém como você deseja. <br /><br />
A primeira linha mostra o estoque atual. Na segunda linha você pode escolher outra distribuição. A terceira linha mostra a diferença entre o estoque antigo e novo.</p>
...
function testSum() {
	if (document.getElementById("remain").innerHTML!=0) {
		document.getElementById("submitText").innerHTML="<a href='javascript:portionOut();'>Distribuir recursos em (etapa 1 de 2)</a>";
...
<script language="JavaScript">var summe=<?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?>;var max123=<?php echo $village->maxstore; ?>;var max4=<?php echo $village->maxcrop; ?>;</script> 
	...
	<?php
		...
		<table id="npc" cellpadding="1" cellspacing="1"> 
			<thead> 
				<tr> 
					<th colspan="5">Comércio NPC</th> 
				</tr> 
				<tr>
			<td class="all"> 
				<a href="javascript:fillup(0);"><img class="r1" src="img/x.gif" alt="Madeira" title="Madeira" /></a> 
			...
			<td class="all"> 
				<a href="javascript:fillup(2);"><img class="r3" src="img/x.gif" alt="Ferro" title="Ferro" /></a> 
			...
			<td class="all"> 
				...
				<td class="sum">Soma:&nbsp;<span id="org4"><?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?></span></td> 
			</tr> 
		</thead> 
		<tbody> 
			<tr> 
			...
			<td class="sum">Soma:&nbsp;<span id="newsum"><?php if(isset($_GET['r1']) && isset($_GET['r2']) && isset($_GET['r3']) && isset($_GET['r4'])) { echo $_GET['r1']+$_GET['r2']+$_GET['r3']+$_GET['r4']; } else { echo 0; } ?></span></td> 
		</tr> 
		<tr> 
			...
			<td class="rem"> 
				<span id="diff3"><?php echo 0-floor($village->acrop); ?></span> 
					...
					<td class="sum">Sobra:&nbsp;<span id="remain">
		...
		<p id="submitButton"> 
	<?php if($session->userinfo['gold'] > 3) { ?><a href="javascript:document.snd.submit();">Comércio dos recursos em (etapa 2 de 2)</a> <span class="none">(Custos: <img src="img/x.gif" class="gold_g" alt="Ouro" title="Ouro" /><b>3</b>)</span><?php } else { echo"<span class='none'>Comércio dos recursos em (etapa 2 de 2)</span> (Custos: <img src='img/x.gif' class='gold' alt='Ouro' title='Ouro' /><b>3</b>)"; }?>	</p>
		<p id="submitText"></p> 
		</form> 
		<script> 
			testSum();
		...
		<?php echo "Você não pode usar o comércio NPC na aldeia WW.";
		}} ?>
	</div>
<?php
}else{
