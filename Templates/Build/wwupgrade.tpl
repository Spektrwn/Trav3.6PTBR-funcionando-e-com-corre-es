...
?>
<p id="contract"><b>Custos</b> atualizar para nível <?php echo $village->resarray['f'.$id]+1+$loopsame+$doublebuild+$master; ?>:<br />
...
<?php
	...
	if($needed_plan == 0){
    	echo "<span class=\"none\">Necessita do Plano de construção da WW.</span>";
	}else{
    	echo "<span class=\"none\">Precisa de mais plano de construção da WW.</span>";
	}
	}
