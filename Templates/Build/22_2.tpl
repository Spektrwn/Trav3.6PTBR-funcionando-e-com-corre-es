    	...
    	echo "<tr><td class=\"desc\">
                   ...
                   if(${'r'.$i}['wood'] > $village->maxstore || ${'r'.$i}['clay'] > $village->maxstore || ${'r'.$i}['iron'] > $village->maxstore) {
					...
					if($village->getProd("crop")>0){
						...
						echo "<br><span class=\"none\">A produção de cereal é negativa para que você nunca alcance os recursos necessários</span></div></td>";
					}
...
<?php if($fail > 0) { 
	echo "<p class=\"switch\"><a id=\"researchFutureLink\" href=\"#\" onclick=\"return $('researchFuture').toggle();\">mostrar mais</a></p>
     ...
     echo"<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u13\" title=\"Bárbaro\" alt=\"Bárbaro\" src=\"img/x.gif\"/>
			<a onclick=\"return Popup(13, 1);\" href=\"#\">Bárbaro</a></div></td><td class=\"cond\"><a href=\"#\" onclick=\"return Popup(22, 4);\">Academia </a>
     ...
     echo "<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u14\" title=\"Espião\" alt=\"Espião\" src=\"img/x.gif\"/>
		 	<a onclick=\"return Popup(14, 1);\" href=\"#\">Espião</a></div></td><td class=\"cond\">
     ...
     echo "<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u15\" title=\"Paladino\" alt=\"Paladino\" src=\"img/x.gif\"/>
			<a onclick=\"return Popup(15, 1);\" href=\"#\">Paladino</a></div></td><td class=\"cond\">
     ...
     echo "<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u16\" title=\"Cavaleiro Teutão\" alt=\"Cavaleiro Teutão\" src=\"img/x.gif\"/>
			<a onclick=\"return Popup(16, 1);\" href=\"#\">Cavaleiro Teutão</a></div></td><td class=\"cond\">
			<a href=\"#\" onclick=\"return Popup(22, 4);\">Academia </a><span title=\"+2\">Nível 15</span><br /><a href=\"#\" onclick=\"return Popup(20, 4);\">
            Cavalaria </a><span title=\"+3\">Nível 10</span>	</td></tr>";
     }
     if(!$technology->meetRRequirement(17) && !$technology->getTech(17)) {
     echo "
			<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u17\" title=\"Aríete\" alt=\"Aríete\" src=\"img/x.gif\"/>
			<a onclick=\"return Popup(17, 1);\" href=\"#\">Aríete</a></div></td><td class=\"cond\"><a href=\"#\" onclick=\"return Popup(22, 4);\">Academia </a>
     ...
     echo "<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u18\" title=\"Catapulta\" alt=\"Catapulta\" src=\"img/x.gif\"/>
            <a onclick=\"return Popup(18, 1);\" href=\"#\">Catapulta</a></div></td><td class=\"cond\"><a href=\"#\" onclick=\"return Popup(21, 4);\">Oficina</a>
     ...
     echo "	<tr><td class=\"desc\"><div class=\"tit\"><img class=\"unit u19\" title=\"Chefe\" alt=\"Chefe\" src=\"img/x.gif\"/>
			<a onclick=\"return Popup(19, 1);\" href=\"#\">Chefe</a></div></td><td class=\"cond\">
			<a href=\"#\" onclick=\"return Popup(16, 4);\">Point de Reunião Militar</a><span title=\"+4\">Nível 5</span><br /><a href=\"#\" onclick=\"return Popup(22, 4);\">
