<form action="build.php" method="post">
        ...
        <input type="hidden" name="action" value="addRoute">
			...
			<thead>
			<tr>
			<th colspan="2">Criar rotas de comércio</th>
			</tr>
			</thead>
				<tbody>
				<tr>
...
?>						</select>
				...
				<tr>
					<th>
						custo:					</th>
					<td>
						<img src="../../<?php echo GP_LOCATE; ?>img/a/gold.gif" alt="Ouro" title="Ouro"> 2
					</td>
				</tr>
				<tr>
					<th>
