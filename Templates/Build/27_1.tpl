...
<body>
    <table id="own" cellpadding="1" cellspacing="1">
        ...
        if($result == 0) {
        	echo '<tr><td colspan="4" class="none">Você não possui nenhum artefato.</td></tr>';
        } else {
		...
		$coor2 = $database->getCoor($artefact['vref']); 
        	...
        	echo '<td class="nam">
                            ...
                            <div class="info">
                                Tesouraria <b>' . $reqlvl . '</b>, Efeito <b>' . $effect . '</b>
                            </div>
                        </td>';
...
?>
    ...
    <table id="near" cellpadding="1" cellspacing="1">
        <thead>
            <tr>
                <th colspan="4">Artefatos na sua área</th>
            </tr>
        ...
        if(mysql_num_rows(mysql_query("SELECT * FROM " . TB_PREFIX . "artefacts")) == 0) {
        	echo '<td colspan="4" class="none">Não há artefatos na sua área.</td>';
        } else {
        	...
        	foreach($rows as $row) {
        		...
        		echo '<div class="info">Tesouraria <b>' . $reqlvl . '</b>, Efeito <b>' . $effect . '</b>';
