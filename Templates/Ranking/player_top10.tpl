	...
	<thead>
		<tr>
			<th>Jogadores Top 10<div id="submenu"><a title="Top 10" href="statistiken.php?id=7"><img class="active btn_top10" src="img/x.gif" alt="Top 10"></a><a title="defensor" href="statistiken.php?id=32"><img class="btn_def" src="img/x.gif" alt="defensor"></a><a title="atacante" href="statistiken.php?id=31"><img class="btn_off" src="img/x.gif" alt="atacante"></a></div><div id="submenu2"><a title="Romanos" href="statistiken.php?id=11"><img class="btn_v1" src="img/x.gif" alt="attacker"></a><a title="Teutões" href="statistiken.php?id=12"><img class="btn_v2" src="img/x.gif" alt="attacker"></a><a title="Gauleses" href="statistiken.php?id=13"><img class="btn_v3" src="img/x.gif" alt="attacker"></a></div></th>
		</tr>
	</thead>
</table>
