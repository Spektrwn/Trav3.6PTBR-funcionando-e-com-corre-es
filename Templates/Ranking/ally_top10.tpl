	...
	<thead>
		<tr>
			<th>Alianças Top 10<div id="submenu"><a title="Top 10" href="statistiken.php?id=43"><img class="active btn_top10" src="img/x.gif" alt="Top 10"></a><a title="Defensor" href="statistiken.php?id=42"><img class="btn_def" src="img/x.gif" alt="Defensor"></a><a title="Atacante" href="statistiken.php?id=41"><img class="btn_off" src="img/x.gif" alt="Atacante"></a></div><div id="submenu2"><a title="Romanos" href="statistiken.php?id=11"><img class="btn_v1" src="img/x.gif" alt="Atacante"></a><a title="Teutões" href="statistiken.php?id=12"><img class="btn_v2" src="img/x.gif" alt="Atacante"></a><a title="Gauleses" href="statistiken.php?id=13"><img class="btn_v3" src="img/x.gif" alt="Atacante"></a></div></th>
		</tr>
	</thead>
</table>
<table cellpadding="1" cellspacing="1" id="top10_offs" class="top10 row_table_data">
	<thead>
		<tr>
			<th onclick="return Popup(3,5)"><img src="img/x.gif" class="help" alt="Instrucões" title="Instrucões">
			</th>
			<th colspan="2">Atacantes da semana</th>
		</tr>
		<tr>
			<td>No.</td>
			<td>Aliança</td>
...
<table cellpadding="1" cellspacing="1" id="top10_defs" class="top10 row_table_data">
	<thead>
		<tr>
			<th onclick="return Popup(3,5)"><img src="img/x.gif" class="help" alt="Instruções" title="Instruções">
			</th>
			<th colspan="2">Defensores da semana</th>
		</tr>
		<tr>
			<td>No.</td>
			<td>Aliança</td>
...
<table cellpadding="1" cellspacing="1" id="top10_climbers" class="top10 row_table_data">
	<thead>
		<tr>
			...
			<th colspan="2">Alpinistas da semana</th>
		</tr>
		<tr>
			<td>No.</td>
			<td>Aliança</td>
...
<table cellpadding="1" cellspacing="1" id="top10_raiders" class="top10 row_table_data">
	<thead>
		<tr>
			...
			<th colspan="2">Ladrões da semana</th>
		</tr>
		<tr>
			<td>No.</td>
			<td>Aliança</td>
