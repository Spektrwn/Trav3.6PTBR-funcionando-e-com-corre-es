...
<table cellpadding="1" cellspacing="1" id="alliance_off" class="row_table_data">
			<thead>
				<tr>
					<th colspan="5">
						As melhores alianças (Ataque)						<div id="submenu"><a title="Top 10" href="statistiken.php?id=43"><img class="btn_top10" src="img/x.gif" alt="Top 10" /></a><a title="defensor" href="statistiken.php?id=42"><img class="btn_def" src="img/x.gif" alt="defensor" /></a><a title="atacante" href="statistiken.php?id=41"><img class="active btn_off" src="img/x.gif" alt="atacante" /></a></div>		    
					</th>
				</tr>
