...
<table cellpadding="1" cellspacing="1" id="alliance" class="row_table_data">
			<thead>
				<tr>
					<th colspan="5">
						As maiores alianças						<div id="submenu"><a title="Top 10" href="statistiken.php?id=43"><img class="btn_top10" src="img/x.gif" alt="Top 10"></a><a title="defensor" href="statistiken.php?id=42"><img class="btn_def" src="img/x.gif" alt="defensor"></a><a title="atacante" href="statistiken.php?id=41"><img class="btn_off" src="img/x.gif" alt="atacante"></a></div>		    
					</th>
				</tr>
		<tr><td></td><td>Aliança</td><td>Jogador</td><td>&Oslash;</td><td>Pontos</td></tr>
		</thead><tbody>  
        <?php
        if(isset($_GET['rank'])){
		$multiplier = 1;
        ...
        if(count($ranking->getRank()) > 0) {
        	...
        	echo "<td class=\"none\" colspan=\"5\">Nenhuma aliança encontrada</td>";
        }
        ?>
 </tbody>
</table>
