...
<div id="map_content">
	<div id="mbig">
		<div id="lightframe">
			<div id="darkframe"><a id="map_popclose" onClick="Close();"><img src="img/x.gif" alt="close Map" title="fechar Mapa"></a>
				...
				<div id="map">
					...
					<map id="map_overlay_large" name="map_overlay_large"> 
						...
						<area id="ma_n2" href="karte2.php?z=<?php echo $generator->getBaseID($xp1,$y);?>" coords="770,430,30" shape="circle" title="Leste"/>
						<area id="ma_n3" href="karte2.php?z=<?php echo $generator->getBaseID($x,$ym1);?>" coords="210,430,30" shape="circle" title="Sul"/>
