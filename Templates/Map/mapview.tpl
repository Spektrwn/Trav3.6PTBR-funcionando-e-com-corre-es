...
<div id="content"  class="map">
	<h1>Mapa (<span id="x"><?php echo $x;?></span>|<span id="y"><?php echo $y;?></span>)</h1>
	<div id="map">
		<script type="text/javascript">
			var text_k = {}
			text_k.details = 'Detalhes';
			text_k.spieler = 'Jogador';
			text_k.einwohner = 'População';
			text_k.allianz = 'Aliança';
			text_k.verlassenes_tal = 'Vale abandonado';
			text_k.besetztes_tal = 'Oasis ocupado';
			text_k.freie_oase = 'Oasis não ocupado';
			var text_x = {}
			text_x.r1 = 'Lumber';
			text_x.r2 = 'Clay';
			text_x.r3 = 'Iron';
		...
		<map id="map_overlay" name="map_overlay">
			<?php echo $map_gen;?>
			<area id="ma_n1" href="karte.php?z=<?php echo $generator->getBaseID($x,$yp1);?>" coords="422,67,25" shape="circle" title="Norte"/>
			<area id="ma_n2" href="karte.php?z=<?php echo $generator->getBaseID($xp1,$y);?>" coords="427,254,25" shape="circle" title="Leste"/>
			<area id="ma_n3" href="karte.php?z=<?php echo $generator->getBaseID($x,$ym1);?>" coords="119,255,25" shape="circle" title="Sul"/>
			<area id="ma_n4" href="karte.php?z=<?php echo $generator->getBaseID($xm1,$y);?>" coords="114,63,25" shape="circle" title="Oeste"/>
		</map>
		...
		if($session->plus){
			echo '<a id="map_makelarge" href="#" onclick="PopupMap('.$bigmid.');" ><img class="ml" src="img/x.gif" alt="large map" title="Mapa Grande"/></a>';
		}
		?>
		...
		<map name="map_navibox">
			...
			<area id="ma_n2p7" href="karte.php?z=<?php echo $generator->getBaseID($xm7,$y) ?>" coords="51,41,73,29,95,41,73,53" shape="poly" title="Leste"/>
			<area id="ma_n3p7" href="karte.php?z=<?php echo $generator->getBaseID($x,$ym7) ?>" coords="4,41,26,29,48,41,26,53" shape="poly" title="Sul"/>
			<area id="ma_n4p7" href="karte.php?z=<?php echo $generator->getBaseID($xp7,$y) ?>" coords="4,15,26,3,48,15,26,27" shape="poly" title="Oeste"/>
		</map>
		<div id="map_coords">
			<form name="map_coords" method="post" action="karte.php">
				...
				<?php if($session->goldclub != 0){echo "<a href=\"crop_finder.php\"><img src=\"".GP_LOCATE."img/misc/cropfinder.gif\" /> Localizador Crop's</a>";}?>
			</form>
		</div>
		<table cellpadding="1" cellspacing="1" id="map_infobox" class="default"><thead><tr><th colspan="2">Detalhes</th></tr></thead><tbody><tr><th>Jogador</th><td>-</td></tr><tr><th>População</th><td>-</td></tr><tr><th>Aliança</th><td></td></tr></tbody></table>
	</div>            
</div>