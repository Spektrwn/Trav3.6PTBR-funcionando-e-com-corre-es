...
<table cellpadding="1" cellspacing="1" id="edit_post"><thead>
	<tr>
        <th colspan="2">Editar resposta</th>
	</tr>
	</thead><tbody>
	<tr>
		<th>Tópico</th>
				...
				<div id="text_toolbar" name="text_toolbar">
					...
					<div id="text_toolbarWindows">
						<div id="text_resources" name="text_resources">
							<a href="javascript:void(0);" bbType="o" bbTag="lumber" ><img src="img/x.gif" class="r1" title="Madeira" alt="Madeira" /></a>
							<a href="javascript:void(0);" bbType="o" bbTag="clay" ><img src="img/x.gif" class="r2" title="Barro" alt="Barro" /></a>
							<a href="javascript:void(0);" bbType="o" bbTag="iron" ><img src="img/x.gif" class="r3" title="Ferro" alt="Ferro" /></a>
							<a href="javascript:void(0);" bbType="o" bbTag="crop" ><img src="img/x.gif" class="r4" title="Cereal" alt="Cereal" /></a></div>
