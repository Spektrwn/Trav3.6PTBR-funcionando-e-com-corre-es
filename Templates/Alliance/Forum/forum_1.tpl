...
<script language="JavaScript" type="text/javascript">
	...
	<tr>
		<th>Tipo de Fórum</th>
		<td><select class="dropdown" id="bid" name="bid" onchange="showCheckList();"><option value="1">Fórum Público</option><option value="2">Fórum de Confederação</option><option value="0"selected>Forum da Aliança</option><option value="3">Fórum Fechado</option></select></td>
	</tr>
	</tbody></table><table cellpadding="1" cellspacing="1" id="ally_list"><thead>
	<tr>

        <th colspan="3">Abrir para mais alianças</th>
	</tr>
	<tr>
		<td>ID da Aliança</td>
		<td>Identificação:</td>
	...
	<tr>
        <th colspan="3">Abrir fórum para os seguintes jogadores</th>
	</tr>
	<tr>
		<td>ID do Usuário</td>
