...
<tr>
<th colspan="2">Convidar um jogador para a aliança</th>
</tr>
</thead><tbody>
<tr><th>Nome</th>
...
<tr>
<th colspan="2">Convidar um jogador para a aliança (pelo ID do usuário)</th>
</tr>
</thead><tbody>
<tr><th>UID</th>
<td><input class="name text" type="text" name="a_uid" maxlength="10"><span class="error"></span></td>
</tr>
</tbody></table>(Para quem tem 'no nome)
...
<th colspan="2">Convites:</th>
</tr></thead>
<tbody>
<?php
if (count($allianceInvitations) == 0) {
	echo "<tr>";
    echo "<td class=none colspan=2>Nenhum</td>";
	echo "</tr>";
    } else {
