...
if($_GET['admin']== "newforum"){
	...
	if($session->access==BANNED){
			echo '<p class="error">Fórum ainda não foi criado</p><p>
			<a href="banned.php"><img id="fbtn_newforum" class="dynamic_img" src="img/x.gif" alt="Novo fórum" /></a></p>';
			}else{
			echo '<p class="error">Fórum ainda não foi criado</p><p>
			<a href="allianz.php?s=2&admin=newforum"><img id="fbtn_newforum" class="dynamic_img" src="img/x.gif" alt="Novo fórum" /></a></p>';
			}}else{
			echo '<p class="error">Fórum ainda não foi criado</p>';
			}
	}				
?>