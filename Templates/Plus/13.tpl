...
<div align="center">
	<table border="1" width="50%" cellspacing="0" cellpadding="0">
		<tr>
			<td align="center" width="25%"><img class="r1" src="img/x.gif" alt="Madeira" title="Madeira" />Madeira</td>
			<td align="center" width="25%"><img class="r2" src="img/x.gif" alt="Barro" title="Barro" />Barro</td>
			<td align="center" width="25%"><img class="r3" src="img/x.gif" alt="Ferro" title="Ferro" />Ferro</td>
			<td align="center" width="25%"><img class="r4" src="img/x.gif" alt="Cereal" title="Cereal" />Cereal</td>
		</tr>
		<tr>
			<td align="center">
<?php
