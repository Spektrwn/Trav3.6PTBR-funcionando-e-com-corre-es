...
if($troops['hero'] > 0) {
		echo "<tr><td class=\"ico\"><a href=\"build.php?id=39\"><img class=\"unit uhero\" src=\"img/x.gif\" alt=\"Herói\" title=\"Herói\" /></a></td>";
		echo "<td class=\"num\">".$troops['hero']."</td><td class=\"un\">Herói</td></tr>";
		$TroopsPresent = True;
}
