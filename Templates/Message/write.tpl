...
<a id="adbook" href="#" onclick="toggleFriendsList(); return false;"><img src="img/x.gif" alt="Addressbook" title="Livro de endereços" /></a>
<div class="clear"></div>
<div class="line"></div>

			<div bbArea="message" id="message_container" name="message_container">
				<div id="message_toolbar" name="message_toolbar">
					<a href="javascript:void(0);" bbType="d" bbTag="b" ><div title="Negrito" alt="Negrito" class="bbButton bbBold"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="i" ><div title="Italico" alt="Italico" class="bbButton bbItalic"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="u" ><div title="Sublinhado" alt="underline" class="bbButton bbUnderscore"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="alliance0" ><div title="Alliança" alt="alliance" class="bbButton bbAlliance"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="player0" ><div title="Jogador" alt="player" class="bbButton bbPlayer"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="coor0" ><div title="Coordenadas" alt="coordinates" class="bbButton bbCoordinate" onclick="this.form.submit(); window.location.href = '?t=1&coor=<?php echo $coor+1; ?>';"></div></a>
					<a href="javascript:void(0);" bbType="d" bbTag="report0" ><div title="Relatório" alt="report" class="bbButton bbReport"></div></a>
					<a href="javascript:void(0);" bbWin="resources" id="message_resourceButton"><div title="Recursos" alt="resources" class="bbButton bbResource"></div></a>
					...
					<a href="javascript:void(0);" bbWin="troops" id="message_troopButton"><div title="Tropas" alt="troops" class="bbButton bbTroop"></div></a>
					<a href="javascript:void(0);" id="message_previewButton" bbArea="message"><div title="Visualização" alt="preview" class="bbButton bbPreview"></div></a>
					<div class="clear"></div>
