 ...
 <table>
  <tr>
   ...
   <td width="250">
	...
	<input type="radio" class="radio" name="type" value="both" <?php if($_GET['s'] == 3) { print 'checked="checked"'; } ?> /> ambos<br />
   </td>
  </tr>
  <tr>
...
?>
 <table id="member">
	<thead>
	<tr>
		<th colspan='5'>Localizador Crop - 15c</th>
	</tr>
	<tr>
		<td>Tipo</td>
		<td>Coordenadas</td>
...
<?php
   ...
   foreach($rows as $dist => $row) {
	   ...
	   if($row['occupied'] == 0) {
		   ...
		   echo "<td>-</td>";
		   echo "<td><b><font color=\"green\">Não ocupada</b></font></td>";
	   } else {
		   ...
		   echo "<td><b><font color=\"red\">Ocupada</b></font></td>";
	   }
...
<table id="member">
	<thead>
	<tr>
		<th colspan='5'>Localizador Crop - 9c</th>
	</tr>
	<tr>
		<td>Tipo</td>
		<td>Coordenadass</td>
...
<table id="member">
	<thead>
	<tr>
		<th colspan='5'>Localizador Crop - 9c and 15c</th>
	</tr>
	<tr>
		<td>Tipo</td>
		<td>Cordenadas</td>
