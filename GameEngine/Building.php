...
class Building {
	...
	public function procResType($ref) {
		...
		switch($ref) {
			...
			case 4: $build = "Campo de Cereal"; break;
			...
			case 13: $build = "Fábrica de Armadura"; break;
			case 14: $build = "Praça do Torneio"; break;
