...
<form action="../GameEngine/Admin/Mods/mainteneceUnban.php" method="POST">
	...
	<table id="member" cellpadding="1" cellspacing="1" >
		<thead>
			<tr>
				<th colspan="2">Abrir Servidor (Desbanir Jogadores pela razão)</th>
			</tr> 
			<tr>
				<td class="on">Desbanir "Razão"</td>
				<td class="hab">Ação</td>
			</tr>
		</thead>
		<tbody> 
			<tr>
...
<table id="member" cellpadding="1" cellspacing="1">
    <thead>
		...
		<tr>
			...
			<td><b>Iniciou Ban / Finaliza Ban</b></td>
			<td><b>Razão</b></td>
			<td></td>
		</tr>
		</thead>
		...
		<?php
			...
			{
				echo '<tr><td colspan="6" class="on">Não há jogadores Banidos</td></tr>';
			}
		?>
    </tbody>
</table>