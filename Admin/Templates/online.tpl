...
<table id="member">
  <thead>
	<tr>
		<th colspan="6">Usuários Online (<?php echo count($active);?>)</th>
	</tr>
  </thead>
	<tr>
		<td>Nome [Acesso]</td>
...
echo '
	<tr>
		...
		<td>'.$totalpop.'</td>
		<td>'.count($varray).'</td>
		<td><img src="../img/admin/gold.gif" class="gold" alt="Ouro" title="Este usuário tem: '.$active[$i]['gold'].' gold"/> '.$active[$i]['gold'].'</td>
	</tr>
';
}
}else{
echo '<tr><td  colspan="6" class="hab">Sem usuários online</td></tr>';
