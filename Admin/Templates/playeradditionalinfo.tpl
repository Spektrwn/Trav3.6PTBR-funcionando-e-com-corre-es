		<table id="member">
			<thead>
				<tr>
					<th colspan="2">Informações Aditionais</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td>
						...
						?> <a href="admin.php?p=editAccess&uid=<?php echo $_GET['uid']; ?>"><img src="../img/admin/edit.gif" title="Editar"></a>
					</td>
				</tr>
				<tr>
					<td>Ouro</td>
					<td><img src="../img/admin/gold.gif"> <?php echo $user['gold']; ?> <a href='admin.php?p=player&uid=<?php echo $id; ?>&g'><img src="../img/admin/edit.gif" title="Editar Ouro"></a>
				</tr>
				<?php
						...
						else
						{
							...
							{ ?>
								<form action="../GameEngine/Admin/Mods/gold_1.php" method="POST">
									...
									<tr>
										<td>Dê o quanto de ouro?</td>
										<td>
											<input class="give_gold" name="gold" value="0">
											<input type="image" src="../gpack/travian_default/img/new/tick.png" title="Dar o Ouro" value="submit">
				...
				<tr>
					<td>Sitter 1</td>
					<td><a href="?p=editSitter&uid=<?php echo $user['id']; ?>"><img src="../img/admin/edit.gif" title="Editar Babás"></a>
						<?php
							if($user['sit1'] >= 1)
							{
					...
					<td>
						<?php
							...
							if($datetime ==0)
							{
								...
								echo "<font color=\"red\"> Sem Proteção</font>";
							}
							else
							{
								if($datetime <= $now)
						...
						?>
					 <a href="admin.php?p=editProtection&uid=<?php echo $id; ?>"><img src="../img/admin/edit.gif" title="Dar proteção ao jogador"></a></td>
				</tr>
				<tr>
					<td>Pontos de Cultura</td>
					<td><a href='admin.php?p=player&uid=<?php echo $id; ?>&cp'><img src="../img/admin/edit.gif" title="Editar Pontos de Cultura"></a>
						<?php
				...
				<tr>
					<td>Pontos de Ataque ("Nesta Semana")</td>
					<td><a href="admin.php?p=editWeek&uid=<?php echo $id; ?>"><img src="../img/admin/edit.gif" title="Editar pontos da semana"></a>
						<?php
							echo $user['ap'];
						?>
					</td>
				...
				<tr>
					<td>Pontos de Defesa ("Nesta Semana")</td>
					<td><a href="admin.php?p=editWeek&uid=<?php echo $id; ?>"><img src="../img/admin/edit.gif" title="Editar pontos da semana"></a>
						<?php
							echo $user['dp'];
						?>
				...
				<tr>
					<td>Recursos Roubados ("Nesta Semana")</td>
					<td><a href="admin.php?p=editWeek&uid=<?php echo $id; ?>"><img src="../img/admin/edit.gif" title="Editar pontos da semana"></a>
						<?php
							echo $user['RR'];
						?>
				...
				<tr>
					<td>Total de pontos por ataque</td>
					<td><a href="admin.php?p=editOverall&uid=<?php echo $id; ?>"><img src="../img/admin/edit.gif" title="Editar Pontos em geral"></a>
						<?php
							echo $user['apall'];
						?>
					</td>
				...
				<tr>
					<td>Total de pontos por defesa</td>
					<td><a href="admin.php?p=editOverall&uid=<?php echo $id; ?>"><img src="../img/admin/edit.gif" title="Editar Pontos em geral"></a>
						<?php
							echo $user['dpall'];
						?>
