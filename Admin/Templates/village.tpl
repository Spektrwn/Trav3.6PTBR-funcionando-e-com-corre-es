...
if(isset($id))
{
	...
	if($village and $user)
	{
		...
		<table id="profile" cellpadding="1" cellspacing="1" >
			<thead>
				<tr>
					<th colspan="3">Informação da Aldeia</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td>Proprietário da aldeia:</td>
					...
					<td>
						<form action="../GameEngine/Admin/mods/editVillageOwner.php" method="POST" accept-charset="UTF-8">
							...
							Proprietário(uid): <input class="text" type="text" name="newowner" value="<?php echo $user['id']; ?>"><input type="image" value="submit" src="../img/admin/edit.gif">
						</form>
					</td>
				<tr>
				...
				<tr>
					<td>População <a href="admin.php?action=recountPop&did=<?php echo $_GET['did']; ?>"><?php echo $refreshicon; ?></a></td>
		...
		<table id="member">
			<thead>
				...
				<tr>
					...
					?>
					<td colspan="2">Armazém <input type="image" src="<?php echo $refreshiconfrm; ?>" value="submit"></form></td>
					<td>Produção</td>
					<td><a href="admin.php?p=editResources&did=<?php echo $_GET['did']; ?>"><img src="../img/admin/edit.gif" title="Editar Recursos e Capacidade"></a></td>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td><img class="r1" src="../img/x.gif"> Madeira</td>
				...
				<tr>
					<td><img class="r2" src="../img/x.gif"> Barro</td>
					<td><center><?php echo floor($village['clay']); ?></center></td>
					<td><center>???</center></td>
					<td><a href="admin.php?p=editResources&did=<?php echo $_GET['did']; ?>"><img src="../img/admin/edit.gif" title="Editar Recursos e Capacidade"></a></td>
				</tr>
				<tr>
					<td><img class="r3" src="../img/x.gif"> Ferro</td>
					<td><center><?php echo floor($village['iron']); ?></center></td>
					<td><center>???</center></td>
					<td><a href="admin.php?p=editResources&did=<?php echo $_GET['did']; ?>"><img src="../img/admin/edit.gif" title="Editar Recursos e Capacidade"></a></td>
				</tr>
				<tr>
					<td><img class="r4" src="../img/x.gif"> Cereal</td>
		...
		<table id="member">
			<thead>
				<tr>
					<th colspan="5">Expansão da aldeia</th>
				</tr>
				<tr>
					<td class="hab">Aldeia</td>
					<td class="hab">População</td>
					<td class="hab">Produção de CP</td>
				</tr>
			</thead>
			<tbody>
				<?php
		...
		<table id="member" cellpadding="1" cellspacing="1" >
			<thead>
				...
				<tr>
					<td class="ra"></td>
					<td class="hab">Nome</td>
					<td class="hab">Coordenadas</td>
					<td class="hab">Lealdade</td>
					<td class="hab">Resursos</td>
				</tr>
			</thead>
			<tbody>
				<?php
				...
				<?php
					...
					elseif($isthere ==0)
					{
						echo '<td colspan="5"><center>Esta aldeia não tem oásis</center></td>';
					}
				?>
			</tbody>
		</table>
		...
		<a href="admin.php?p=editVillage&did=<?php echo $_GET['did']; ?>" title="Editar Aldeia">
...
<table id="member" cellpadding="1" cellspacing="1" >
	<thead>
		<tr>
			<th colspan="5">Edifícios</th>
		</tr>
		<tr>
			<td class="on">ID</td>
			<td class="on">GID</td>
			<td class="hab">Nome</td>
			<td class="on">Nível</td>
...
<br /><br />
	...
	<a href="admin.php?p=villagelog&did=<?php echo $_GET['did']; ?>">Log de construão da aldeia</a>
	<br />
</div>
<?php
}
