	...
	<form action="../GameEngine/Admin/Mods/editResources.php" method="POST">
		...
		<table id="member" cellpadding="1" cellspacing="1" >
			<thead>
				...
				<tr>
					<td class="on">Recursos</td>
					<td class="hab">Quantidade</td>
					<td class="hab">Capacidade Máxima</td>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="on"><img src="../img/admin/r/1.gif"> Madeira</td>
				...
				<tr>
					<td class="on"><img src="../img/admin/r/3.gif"> Ferro</td>
					<td class="hab">
