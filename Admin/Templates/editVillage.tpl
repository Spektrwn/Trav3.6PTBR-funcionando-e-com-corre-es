...
if(isset($id))
{
	...
	<form action="../GameEngine/Admin/Mods/editBuildings.php" method="POST">
		...
		<a href="#" onclick="showStuff('instructions'); return false;">Mostrar Instruções</a>
		<span id="instructions" style="display: none;">
			<h4>ID's Construções (Posição)</h4>
			...
			<table id="member">
				...
				<tbody>
					...
					<tr>
						<td class="on">41.</td>
						<td class="on">Bebedouro para cavalo</td>
					</tr>
				</tbody>
			</table>
			<a href="#" onclick="hideStuff('instructions'); return false;">Esconder Instruções</a>
		</span>
		...
		<table id="member" cellpadding="1" cellspacing="1" >
			<thead>
				<tr>
					<th colspan="4">Modificar Construções</th>
				</tr>
				<tr>
					<td class="on">ID</td>
					<td class="on">GID</td>
