		...
		<tbody>
			...
			<form method="post" action="admin.php">
				...
				<td colspan="1" style="text-align: center;">
					<input type="checkbox" name="del_troop" value="1"> <strike>Deletar Tropas </strike>(DESLIGADO)
				</td>
			</tr>
			<tr>
				<td>
			...
			<form method="post" action="admin.php">
				...
				<input type="hidden" name="admid" id="admid" value="<?php echo $_SESSION['id']; ?>">
				<td colspan="1" style="text-align: center;">
					<input type="checkbox" name="clean_ware" value="1"> Esvaziar Armazéns
				</td>
			</tr>
			<tr>
				<td>
