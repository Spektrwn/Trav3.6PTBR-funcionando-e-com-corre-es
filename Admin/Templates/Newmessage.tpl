...
if(isset($id))
{
	...
	<h4>Escrever nova mensagem para <a href="admin.php?p=player&uid=<?php echo $user['id'] ?>"><?php echo $user['username']; ?></a></h4>
	...
	<div id="content" class="messages">
		...
		<div id="read_content" class="msg_content">
			...
			<div class="message" style="margin-top: 10px;">
				<textarea id="message" name="message" style="background-image: url('../<?php echo GP_LOCATE; ?>img/msg/underline.gif'); background-repeat: repeat; font-size: 12px; border: medium none; height: 258px; line-height: 16px; width: 412px; font-family: Verdana,Arial,Helvetica,sans-serif;">Mensagem Aqui</textarea>
			</div>
			<p class="btn">
	...
	if(isset($_GET['msg']))
	{
		echo "<font color=\"blue\">Mensagem enviada</font>";
	}
	else
	{
		echo '';
...
{
	echo "<br /><br />Não encontrado. <a href=\"javascript: history.go(-1)\"> Voltar</a>";
}?>