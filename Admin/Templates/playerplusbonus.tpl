<th><b><font color='#71D000'>P</font><font color='#FF6F0F'>l</font><font color='#71D000'>u</font><font color='#FF6F0F'>s</font></b></th>
								<td>
									<?php
										...
										if($datetime ==0)
										{
											echo '<img src="../gpack/travian_default/img/a/del.gif">';
											echo "<font color=\"red\"> Sem Bonus</font>";
										}
										else
										{
											if($datetime <= $now)
							...
							<tr>
								<th><img src="../img/admin/r/1.gif"> Bônus</th>
								<td>
									<?php
										$datetime = $user['b1'];
										$now = time();
							...
							<tr>
								<th><img src="../img/admin/r/2.gif"> Bônus</th>
								<td>
									<?php
										$datetime = $user['b2'];
										$now = time();
							...
							<tr>
								<th><img src="../img/admin/r/3.gif"> Bônus</th>
								<td>
									<?php
										$datetime = $user['b3'];
										$now = time();
							...
							<tr>
								<th><img src="../img/admin/r/4.gif"> Bônus</th>
								<td>
									<?php
										$datetime = $user['b4'];
										$now = time();
