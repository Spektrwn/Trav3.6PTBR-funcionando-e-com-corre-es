...
<td colspan="10"><a href="admin.php?p=player&uid=<?php echo $database->getUserField($dataarray[0],"id",0); ?>"><?php echo $database->getUserField($dataarray[0],"username",0); ?></a> da aldeia <a href="karte.php?d=<?php echo $dataarray[1]."&amp;c=".$generator->getMapCheck($dataarray[1]); ?>"><?php echo $database->getVillageField($dataarray[1],"name"); ?></a></td>
</tr>
</thead>
<tbody class="units">
<tr>
...
<?php } ?>
	<tbody class="goods"><tr><th>Recompensa</th><td colspan="10">
	<div class="res"><img class="r1" src="img/x.gif" alt="Madeira" title="Madeira" /><?php echo $dataarray[23]; ?> | <img class="r2" src="img/x.gif" alt="Barro" title="Barro" /><?php echo $dataarray[24]; ?> | <img class="r3" src="img/x.gif" alt="Ferro" title="Ferro" /><?php echo $dataarray[25]; ?> | <img class="r4" src="img/x.gif" alt="Cereal" title="Cereal" /><?php echo $dataarray[26]; ?></div><div class="carry"><img class="car" src="img/x.gif" alt="cacarregando" title="carregando" /><?php echo ($dataarray[23]+$dataarray[24]+$dataarray[25]+$dataarray[26])."/".$dataarray[27]; ?></div>
    </td></tr></tbody></table>
