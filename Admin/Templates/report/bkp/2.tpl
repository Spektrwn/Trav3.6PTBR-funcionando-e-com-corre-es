				...
				<table cellpadding="1" cellspacing="1" id="attacker">
					<thead>
						<tr>
							...
							<td colspan="10"><a href="admin.php?p=player&uid=<?php echo $database->getUserField($dataarray[0],"id",0); ?>"><?php echo $database->getUserField($dataarray[0],"username",0); ?></a> da aldeia <a href="admin.php?p=village&did=<?php echo $dataarray[1] ?>"><?php echo $database->getVillageField($dataarray[1],"name"); ?></a></td>
						</tr>
					</thead>
					<tbody class="units">
						<tr>
						...
						{ 
							...
							<table cellpadding="1" cellspacing="1" class="defender">
								<thead>
									<tr>
										<td class="role">Defensor</th>
										<td colspan="10"><?php if($targettribe=='4'){ echo'<a href="admin.php?p=player&uid='.$database->getUserField($dataarray[28],"id",0).'">'.$database->getUserField($dataarray[28],"username",0).'</a> da aldeia <a href="admin.php?p=player&did='.$dataarray[29].'&amp;c='.$generator->getMapCheck($dataarray[29]).'">'.stripslashes($dataarray[30]).'</a>'; } else { echo"Reforço"; } ?></td>
									</tr>
								</thead>
								<tbody class="units">
									<tr>
