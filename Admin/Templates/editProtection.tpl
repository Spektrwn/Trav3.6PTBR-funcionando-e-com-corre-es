	...
	<form action="../GameEngine/Admin/Mods/editProtection.php" method="POST">
		...
		<input type="hidden" name="id" value="<?php echo $id; ?>" />
			...
			<table id="profile" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						<th colspan="2">Editar Proteção para: <a href="admin.php?p=player&uid=<?php echo $user['id']; ?>"><?php echo $user['username']; ?></a></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>Dar Proteção para</td>
						<td>
							<input class="fm" name="protect" value="0" style="width: 60%;"> Dias
						</td>
					</tr>
				</tbody>
			</table>
