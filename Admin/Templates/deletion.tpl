	...
	if($user)
	{
		...
		<form action="" method="post">
			...
			<table id="member">
				<thead>
					<tr>
						<th colspan="4">Apagar jogador</th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input type="submit" class="c5" value="Apagar jogador"></td>
					</tr>
				</tbody>
			</table>
			<br /><br /><font color="Red"><b>AVISO: APAGUE TODAS AS ALDEIAS DOS JOGADORES ABAIXO ANTES DE APAGAR O JOGADOR!</font></b><br /><br />
