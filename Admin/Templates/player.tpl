...
if(isset($id))
{
	...
	if($user)
	{
		...
		<table id="member" cellpadding="1" cellspacing="1">
			<thead>
				<tr>
					<th colspan="6">Historico de banido (<?php echo $numbans; ?>)</th>
				</tr>
				<tr>
					<td class="hab"><b>Começou</b></td>
					<td class="hab"><b>Finalizou</b></td>
					<td class="hab"><b>Duração</b></td>
					<td class="on"><b>Razão</b></td>
				</tr>
			</thead>
			<tbody>
				<?php
