			...
			<tr>
				<td class="details">
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<td>
								<select name="tribe" class="dropdown">
									<option value="1" <?php if($user['tribe'] == 1) { echo "selected='selected'"; } else {} ?>>Romano</option>
									<option value="2" <?php if($user['tribe'] == 2) { echo "selected='selected'"; } else {} ?>>Teutão</option>
									<option value="3" <?php if($user['tribe'] == 3) { echo "selected='selected'"; } else {} ?>>Gaulês</option>
									<option value="4" <?php if($user['tribe'] == 4) { echo "selected='selected'"; } else {} ?>>Natureza</option>
						...
						<tr>
						<tr>
							<th>Pergunta</th><td><input class="fm" name="quest" value="<?php echo $user['quest']; ?>"></td></tr>
						<tr>
							<td colspan="2" class="empty"></td>
						</tr>
						<tr>
							<td colspan="2"><a href="?p=player&uid=<?php echo $user['id']; ?>"><span class="rn2" >&raquo;</span> Voltar</a></td>
						</tr>
						<tr>
							<td colspan="2" class="empty"></td>
						</tr>
...
{
	echo "<br /><br />Não existe. <a href=\"javascript: history.go(-1)\"> Voltar</a>";
}
?>