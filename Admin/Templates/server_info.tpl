...
<br /><br />
	<table id="profile">
		<thead>
			<tr>
				<th colspan="2">Informação dos Jogadores</th>
			</tr>
		 </thead>
		 <tbody>
			<tr>
				<td>Jogadores Registrados</td>
				<td><?php echo $users; ?></td>
			</tr>
			<tr>
				<td>Jogadores Ativos</td>
	...
	<table id="profile">
		<thead>
			<tr><th colspan="3">Informação dos Jogadores</th></tr>
			<td class="b">Tribo</td>
			<td class="b">Registrados</td>
			<td class="b">Porcentagem</td>
		</thead>
		<tbody>
			<tr>
				<td>Romanos</td>
	...
	<table id="profile">
		<thead>
		 <tr>
			<th colspan="3">Informação do Servidor</th>
		</tr>
			<td class="b"></td>
			<td class="b">Total</td>
			<td class="b">Média</td>
		...
		<tbody>
			<tr>
				<td><img src="../<?php echo GP_LOCATE; ?>img/a/gold.gif" alt="Ouro" title="Ouro"> Ouro</td>
	...
	<table id="member">
		<thead>
			<tr>
				<th colspan="10">Tropas no Servidor</th>
			</tr>
			<?php
				for($i=1; $i<11; $i++)
				{
