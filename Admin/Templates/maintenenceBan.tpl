...
<form action="../GameEngine/Admin/Mods/mainteneceBan.php" method="POST">
	...
	<table id="member" cellpadding="1" cellspacing="1" >
		<thead>
			<tr>
				<th colspan="2">Fechar Servidor (Banir todo mundo)</th>
			</tr> 
			<tr>
				<td class="on">Duração</td>
				<td class="hab">Começando</td>
			</tr>
		</thead>
		<tbody> 
			<tr>
			...
			<tr>
				<td>Padrão: 1 Hora<br />Valor: Horas (0.5) por 30 minutos</td>
				<td>Padrão: Agora
			</tr>
			<tr>
				<td class="hab" colspan="2"><center><input type="text" class="fm" name="reason" value="Tempo de inatividade do servidor"></center></td>
			</tr>
			<tr>
