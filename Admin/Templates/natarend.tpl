...
<center><b>Criar aldeias com Maravilha do Mundo = WW?</b></center>

<center><br /><input class="give_gold" name="vill_amount" id="vill_amount" value="20" maxlength="4">&nbsp;<font color="gray" size="1">Insira o número de Maravilhas e pressione 'enter'</center>
			<tr>
