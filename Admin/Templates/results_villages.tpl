...
<table id="member">
	<thead>
		<tr>
			<th colspan="5">
				Aldeia existente (<?php echo count($result);?>)
			</th>
		</tr>
		<tr>
			<td colspan="5"></td>
	...
	<thead>
		<tr>
			...
			<td style="background-color: #F3F3F3;">Nome da aldeia</th>
			<td style="background-color: #F3F3F3;">Proprietário da aldeia</th>
			<td style="background-color: #F3F3F3;">População</th>
				...
				<tfoot>
					<tr>
						<td colspan="5" style="background-image: url(../../<?php echo GP_LOCATE; ?>img/f/c4.gif);">
							<center>
								<font color="red">'.count($result).'</font> Aldeias existentes "<font color="red">'.$_POST['s'].'</font>"
							</center>
						</td>
					</tr>';
			}
			else
			{
				...
				<tfoot>
					<tr>
						<td colspan="5" style="background-image: url(../../<?php echo GP_LOCATE; ?>img/f/c4.gif);">
							<center>
								<font color="#9F9F90">Nenhuma Aldeia encontrada</font> <font color="red">'.$_POST['s'].'</font>
							</center>
						</td>
					</tr>';
			}
